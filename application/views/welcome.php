...
<section class='container'>
    <hgroup>
        <h1>Welcome to Yu Zhou's Coding World</h1>
    </hgroup>
...
&lt;p&gt;&lt;embed type="application/x-shockwave-flash" src="http://music.163.com/style/swf/widget.swf?sid=2534074,28923973,28923972&type=2&auto=0&width=310&height=500" width="380" height="500"/&gt;&lt;/p&gt;</pre>


                <ul>
                    <li><a href="http://lanyes.org/web/578.html">Learn more about adding API of music player.</a></li>
        ...
        <section class="col-xs-12 col-sm-6 col-md-6">
            <section class="codeigniter">
                <h2>About Xiami .net Music API</h2>
                ...
                <pre>
&lt;object data="http://img.xiami.net/res/fm/xiamiRadio_20120612.swf?v=1428236788" type="application/x-shockwave-flash" width="695" height="300" id="radioPlayer" name="radioPlayer"&gt;
    &lt;param name="movie" value="http://img.xiami.net/res/fm/xiamiRadio_20120612.swf?v=1428236788"&gt;
    &lt;param name="quality" value="high"&gt;
    &lt;param name="wmode" value="Opaque"&gt;
    &lt;param name="allowScriptAccess" value="always"&gt;
    &lt;param name="FlashVars" value="dataUrl=http://www.xiami.com/radio/xml/type/5/id/64548&helpUrl=http://www.xiami.com/websitehelp#help6_1&changeRadioUrl=http://www.xiami.com/radio&unlikeartist=1&amp;ctNum=20000&srNum=120"&gt;
&lt;/object&gt;</pre>
    ...
    <footer>
        <div class="logo" style="display: none;"><a href="https://www.openshift.com/"></a></div>
    </footer>
</section>
